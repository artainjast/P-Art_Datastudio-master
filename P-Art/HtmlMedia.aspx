<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HtmlMedia.aspx.cs" Inherits="P_Art.HtmlMedia" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" RenderMode="Block" ChildrenAsTriggers="false" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                ...
                <div class="home2">
                    ...
                    <asp:HiddenField runat="server" ID="hdfGroupsSites" />
        ...
        <section class="fixed-table-of-content appear" style="display:none;">
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            $('.page footer').each(function () {
                ...
                try {
                    var groups = $('#<%= hdfGroupsSites.ClientID %>').val().split(',');
                    $.each(groups, function (i) {
                        ...
                        $('.newsItem[data-group="' + groups[i] + '"]').each(function (i, elm) {
                            ...
                            finalLastListNewMedia += "<h5 class='uncollapse'>" + groups[i] + " </h5><ul class='uncollapse' style='display: none;'>" + rawHtml + "</ul>";
                ...
                $('.fixed-table-of-content div').append(fehrestHtml + finalLastList + finalLastListNewMedia);
            });
