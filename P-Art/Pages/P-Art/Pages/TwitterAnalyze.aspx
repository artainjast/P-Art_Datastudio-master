<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="TwitterAnalyze.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.TwitterAnalyze" %>
...
<asp:Content ID="PanelContent" ContentPlaceHolderID="PanelContentPlaceHolder" runat="server">
    ...
    <div class="chartContainer">
        ...
        <span class="title">نمودار فراوانی کلید واژه ها در توییتر</span>
        <div id="KeyWordCountChart" class="ControlTopPadding"></div>
    </div>

        <div  class="chartContainer">
        <div id="progress2" class="progressbar"></div>
        <span class="title">نمودار فراوانی کاربر های توییتر</span>
       ...
       <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            TwitterUsersCountChart(fromDate, toDate);
        ...
        function TwitterKeywordCountChart(fromdate, todate, callback) {
            ...
            $.ajax({
                type: "POST",
                url: "/pages/P-Art/Pages/TwitterAnalyze.aspx/TwitterKeywordCountChart",
        ...
        function TwitterUsersCountChart(fromdate, todate, callback) {

            $.ajax({
                type: "POST",
                url: "/pages/P-Art/Pages/TwitterAnalyze.aspx/TwitterUsersCountChart",
                data: "{'fromDate':'" + fromdate + "','toDate':'" + todate + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
