<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="ForeignNews.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.ForeignNews" %>
    ...
    <section class="posts">
        ...
        <div class="newsSection persian newsStream">
            <asp:Repeater ID="news_list" runat="server" OnItemDataBound="news_list_ItemDataBound">
                ...
                <ItemTemplate>
                    <div class="showFehrest darkPink">
        ...
        <div class="clearfix"></div>
        <div class="newsGroupSection persian newsStream darkPink" style="display: none;">
            <asp:Repeater ID="rptGroupNewKeyword" runat="server" OnItemDataBound="rptGroupNewKeyword_ItemDataBound">
                ...
                <ItemTemplate>
                    ...
                    <asp:Repeater ID="rptGroupNewsList" runat="server" OnItemDataBound="rptGroupNewsList_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <div class="articleSetion groupOrderItem darkPink1">
