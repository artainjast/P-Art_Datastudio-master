<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="TelegramAnalyze.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.TelegramAnalyze" %>
    ...
    <div class="chartContainer">
       ...
       <script type="text/javascript">
        ...
        function TelegramKeywordCountChart(fromdate, todate, callback) {
            ...
            $.ajax({
                type: "POST",
                url: "/pages/P-Art/Pages/TelegramAnalyze.aspx/TelegramKeywordCountChart",
        ...
        function TelegramChannelsCountChart(fromdate, todate, callback) {
            ...
            $.ajax({
                type: "POST",
                url: "/pages/P-Art/Pages/TelegramAnalyze.aspx/TelegramChannelsCountChart",
                data: "{'fromDate':'" + fromdate + "','toDate':'" + todate + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
