...
{
    public partial class TwitterAnalyze : System.Web.UI.Page
    {
        ...
        public static ChartValue[] TwitterKeywordCountChart(string fromDate, string toDate)
        {
            ...
            var KeyCount = from k in _dbStatic.Tbl_TwitterPost
            ...
            KeyCountList = (from a in KeyCount
                            join b in _dbStatic.Tbl_TwitterKeywords on a.KeyId equals b.ID
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static ChartValue[] TwitterUsersCountChart(string fromDate, string toDate)
        {
            long fromDateIndex = long.Parse(fromDate.Replace("/", "") + "0000");
            long toDateIndex = long.Parse(toDate.Replace("/", "") + "2500");
            ...
            var KeyCountList1 = (from k in _dbStatic.Tbl_TwitterPost
                                 where k.PanelID == ParminId && k.DateTimeIndex >= fromDateIndex && k.DateTimeIndex <= toDateIndex
                                 group k by k.UserName).ToList();
            ...
            return KeyCountList.OrderByDescending(k => k.Value).Take(15).ToArray();
