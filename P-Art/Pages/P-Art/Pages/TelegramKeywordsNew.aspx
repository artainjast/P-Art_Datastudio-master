<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="TelegramKeywordsNew.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.TelegramKeywordsNew" %>
...
<asp:Content ID="PanelContent" ContentPlaceHolderID="PanelContentPlaceHolder" runat="server">
    ...
    <script>
        ...
        $(".keyGroupButton").click(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "/Pages/P-Art/Pages/TelegramKeywordsNew.aspx/GetTelegramKeyGroupWithId",
        ...
        $(".keywordButton").click(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "/Pages/P-Art/Pages/TelegramKeywordsNew.aspx/GetTelegramKeywordWithId",
                data: "{'KeyID':'" + keyId + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
