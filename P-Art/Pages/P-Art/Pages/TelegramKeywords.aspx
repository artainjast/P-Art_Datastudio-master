<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="TelegramKeywords.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.TelegramKeywords" %>
...
<%--            <div class="ItemForm">
                        ...
                        <asp:Repeater ID="rptKeywordItem" runat="server">
                            <ItemTemplate>
                                <div class="KeyItem">
                                    ...
                                    <a class="keywordButton"   data-keyid="<%# Eval("Id") %>" ><%# Eval("SearchKeyWord") %></a>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
    ...
    <script>
        ...
        $(".keyGroupButton").click(function (e) {
            $("#divAddGroup").fadeIn(500);
            $("#txtGroupName").val("");
            $("#txtGroupOrder").val("");
            var KeyGroupID = $(this).attr("data-groupid");
            $.ajax({
                type: "POST",
                url: "/Pages/P-Art/Pages/TelegramKeywords.aspx/GetTelegramKeyGroupWithId",
        ...
        $(".keywordButton").click(function (e) {
            $("#divAddKeyword").fadeIn(500);
            $("#txtKeywordTitle").val("");
            $("#txtKeyOrder").val("");
            var keyId = $(this).attr("data-keyid");
            $.ajax({
                type: "POST",
                url: "/Pages/P-Art/Pages/TelegramKeywords.aspx/GetTelegramKeywordWithId",
                data: "{'KeyID':'" + keyId + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    $("#lstGroup").val(data.d.FK_GroupId);
                    $("#txtKeywordTitle").val(data.d.SearchKeyWord);
