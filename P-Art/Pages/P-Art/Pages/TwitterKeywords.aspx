<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="TwitterKeywords.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.TwitterKeywords" %>
...
<asp:Content ID="PanelContent" ContentPlaceHolderID="PanelContentPlaceHolder" runat="server">
    ...
    <script>
        ...
        $(".keyGroupButton").click(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "/Pages/P-Art/Pages/TwitterKeywords.aspx/GetTwitterKeyGroupWithId",
        ...
        $(".keywordButton").click(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "/Pages/P-Art/Pages/TwitterKeywords.aspx/GetTwitterKeywordWithId",
                data: "{'KeyID':'" + keyId + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
