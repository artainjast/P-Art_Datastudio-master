<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="TelegramMessageShowNew.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.TelegramMessageShowNew" %>
            ...
            <div class="postDetailsText">
                ...
                <div class="meta">
                    ...
                    <div class="spans">
                        ...
                        <a href="#" runat="server" target="_blank" id="lnk_news" rel="nofollow" class="btn btn-outline-success cur-p">لینک پست</a>
                    </div>
