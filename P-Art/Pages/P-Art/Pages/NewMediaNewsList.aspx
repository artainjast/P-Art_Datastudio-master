<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="NewMediaNewsList.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.NewMediaNewsList" %>
...
<asp:Content ID="PanelContent" ContentPlaceHolderID="PanelContentPlaceHolder" runat="server">
    ...
    <div class="newsFilter persian">
        ...
        <div>
            ...
            <span>
                <label  for="ddlSiteGroup">موضوع</label>

                <asp:DropDownList runat="server" ID="ddlSiteGroup" CssClass="btn btn-outline-info cur-p" Style="margin-left: 20px; height: 35px">
                    <asp:ListItem Text="تمام موضوع ها" Value="0" Selected="True" />
                    <asp:ListItem Text="اقتصادی" Value="1" />
                    <asp:ListItem Text="سیاسی" Value="2" />
                    <asp:ListItem Text="بین المللی" Value="3" />
                    <asp:ListItem Text="ورزشی" Value="4" />
                    <asp:ListItem Text="علم و فناوری" Value="5" />
                    <asp:ListItem Text="سینما" Value="6" />
                    <asp:ListItem Text="حوادث" Value="7" />
                    <asp:ListItem Text="خودرو" Value="8" />
                    <asp:ListItem Text="سلامت" Value="9" />
                    <asp:ListItem Text="موسیقی" Value="10" />
                    <asp:ListItem Text="طلا و ارز" Value="11" />
                </asp:DropDownList>
            ...
            <span>
                <label style="display:none" for="PageSizeDropDownList">مخزن</label>

                <asp:DropDownList Visible="false" runat="server" ID="storageTypeDropDownList" CssClass="btn btn-outline-info cur-p" Style="margin-left: 20px; height: 35px">
    ...
    <div class="newsBultan persian">
        <div>
            ...
            <asp:CheckBox ID="check_highlight" Visible="false" runat="server" CssClass="CheckBox" Text="هایلایت کلید واژه ها" />
            <asp:CheckBox ID="check_related" Visible="false"   runat="server" CssClass="CheckBox" Text="شناسایی اخبار مرتبط" />
            <asp:CheckBox ID="check_rujeld" Checked="true" CssClass="CheckBox" runat="server" Text="رو جلد" />
            <asp:CheckBox ID="check_ChartKhabar" Visible="false" runat="server" CssClass="CheckBox" Text="نمودار" />
                ...
                <HeaderTemplate>
                    <div class="pagingGridContainer">
                        <div class="pagingGridHeader">
                            ...
                            <span class="HeaderGroup">موضوع</span>
                ...
                <ItemTemplate>
                    <div class="GridContainer">
                        <div class="GridItem">
                            ...
                            <span class="ItemGroup" title='<%# Eval("GroupTitle") %>'>
                                <%# Eval("GroupTitle").ToString().Trim() %>
                            </span>
                         ...
                         <%--   <span class="ItemCommand">
                               <a data-id='<%# Eval("id") %>' class="btn info"  onclick="addToInbox(this)" ><i class="fa fa-plus"></i>اینباکس</a>
                            </span>--%>
    ...
    <script type="text/javascript">
        ...
        function addToInbox(element) {
            ...
            $.ajax({
                ...
                data: "{'MediaId':'" + newsID + "' , 'MediaType': 2}",
    ...
    <script>
        ...
        $('.ItemTitle').live('click', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "/Pages/P-Art/Pages/NewMediaNewsList.aspx/DetailShowNews",
                data: "{'NewsID':'" + newsID + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
   ...
   <script>
        ...
        function GetPagingHTMLBultan(element) {
            ...
            linkUrl = linkUrl + "/HtmlGroupNewMediaNews.aspx?ArchiveId=";
            //generate bultan archive
            $.ajax({
                type: "POST",
                url: "/pages/p-art/pages/NewMediaNewsList.aspx/SetBultanArchive",
