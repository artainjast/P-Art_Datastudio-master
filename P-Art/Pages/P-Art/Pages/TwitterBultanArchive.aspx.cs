...
{
    public partial class TwitterBultanArchive : System.Web.UI.Page
    {
        ...
        {
            var bultans = _db.Tbl_BultanArchive.Where(b => b.BultanType == 9 && b.PanelId == parmin && b.NewsDateIndex >= fromDateTimeIndex && b.NewsDateIndex <= toDateTimeIndex).OrderByDescending(s => s.ArchiveId).ToList();
