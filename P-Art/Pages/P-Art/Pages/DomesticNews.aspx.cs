...
namespace P_Art.Pages.P_Art.Pages
{
    ...
    public partial class DomesticNews : System.Web.UI.Page
    {
        ...
        private void LoadData(int siteType)
        {
            ...
            if (diffrentDt.Days == 0)
            {
                if (fromDateTime != 0 && toDateTime != 0)
                {
                    DomesticNewsList = (from news in _db.DomesticNewsTodayView
                                        where UserPanelList.Contains(news.ParminId) && news.NewsDateTimeIndex >= fromDateTime && news.NewsDateTimeIndex <= toDateTime && SiteIDs.Contains(news.SiteID)
                                        ...
                                        }).OrderByDescending(n => n.NewsDateTimeIndex).ToList();
                }
            }
            ...
            foreach (var item in DomesticNewsList)
            {
                ...
                GroupNewsList.Add(new Tbl_News_Type
                {
                    ...
                    GroupOrder = SelectedGroup.GroupOrder,
                    ...
                    NewsGroupOrder = item.NewsGroupOrder,
                    OrderItem = item.OrderItem != null ? (int)SelectedGroup.OrderItem : 0,
                    KeywordName = item.KeywordName,
                    NewsTypeShow = NewsTypeShow,
                    NewsKeyTagsOrder = Convert.ToInt32(SelectedGroup.OrderItem),
                    NewsKeyGroupsOrder = Convert.ToInt32(SelectedGroup.GroupOrder)
