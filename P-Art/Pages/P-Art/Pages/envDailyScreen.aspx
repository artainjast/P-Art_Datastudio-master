<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="envDailyScreen.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.envDailyScreen" %>
...
<asp:Content ID="PanelContent" ContentPlaceHolderID="PanelContentPlaceHolder" runat="server">
    ...
    <div class="PageSubLink">
        <ul>
            <li><a href="/AdvertisesList" runat="server"><span><i class="far fa-window-restore"></i></span>تازه ها</a></li>
            <%-- <li><a href="/Analysis" runat="server"><span><i class="fas fa-chart-line"></i></span>تحلیل محتوا</a></li>--%>
            <li style="color: #fec006"><a class="flat-gray-button" style="color: #fec006"><span><i class="fas fa-calendar-day fa-sm"></i></span>وضعیت اکران روزانه</a></li>
                ...
                <ItemTemplate>
                    <div class="AdvertiseCard">
                        <div class="AdvertiseImageContainer">
                            <img class="AdvertiseImage" src="<%# "http://media.payeshmedia.ir/EnvAds/BilbordImages/" + Eval("LastImageName").ToString() %>" onerror="this.src='/Pages/P-Art/Images/newsPreview.jpg'" alt="" />
                        </div>

                        <div class="container">
                            <div class="brandPic">
                                <span>
                                    <img src="<%# "http://media.payeshmedia.ir/EnvAds/BrandsSigneImages/" + Eval("BrandImageName").ToString() %>" onerror="this.src='/Pages/P-Art/Images/profile-insta.jpg'" />
                                </span>
