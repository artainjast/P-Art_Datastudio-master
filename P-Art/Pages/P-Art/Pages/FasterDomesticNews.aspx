<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="FasterDomesticNews.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.FasterDomesticNews" %>
...
<asp:Content ID="PanelContent" ContentPlaceHolderID="PanelContentPlaceHolder" runat="server">
    ...
    <div class="PageSubLink">
        <ul>
            ...
            <li><a id="keywordPageButton" runat="server"><span><i class="fas fa-key"></i></span>کلید واژه</a></li>
    ...
    <section class="posts">
        ...
        <div class="control-box filter newsFilter persian">
            ...
            <div>
                ...
                <a style="display: none" href="/News/Latest/?time=30" class="btn btn-outline-secondary cur-p">30 دقیقه پیش
                </a>
                <a style="display: none" href="/News/Latest/?time=60" class="btn btn-outline-secondary cur-p">1 ساعت پیش
                </a>
                <a style="display: none" href="/News/Latest/?time=180" class="btn btn-outline-secondary cur-p">3 ساعت پیش
                </a>
                <a style="display: none" href="/News/Latest/?time=360" class="btn btn-outline-secondary cur-p">6 ساعت پیش
                </a>
                <a style="display: none" href="/News/Latest/?time=720" class="btn btn-outline-secondary cur-p">12 ساعت پیش
                </a>
                <a style="display: none" id="lnk_yesterday" runat="server" href="/News/Latest/?time=1440" class="btn btn-outline-secondary cur-p">1 روز پیش
                </a>
                <span>
                    ...
                    <%--  <asp:Button ID="ExportExcelReportButton" runat="server" CssClass="btn btn-success cur-p" Text="گزارش اکسل" OnClick="ExportExcelReportButton_Click" />--%>
                </span>
            </div>
        </div>
        <div class="control-box bultan newsBultan">
            <div>
                ...
                <asp:Button ID="btn_GroupSaveState" runat="server" Text="ذخیره وضعیت گروه بندی" CssClass="btn btn-outline-secondary cur-p" OnClick="btn_GroupSaveState_Click" />
                ...
                <a id="btn_generateGroupHtml" runat="server" onclick="GetGroupHTMLBultan(this)" class="btn btn-outline-success cur-p">ساخت بولتن</a>
        ...
        <div class="list-type newsStreamHeaderOutOfBox">
            <asp:Button ID="rbtCommonList" runat="server" Text="تمامی اخبار" CssClass="mediaFocusButton ControlRightMargin" OnClick="rbtCommonList_Click" />
            <asp:Button ID="rbtGroupList" runat="server" Text="گروه بندی اخبار" CssClass="mediaFocusButton " OnClick="rbtGroupList_Click" />
        ...
        <div id="newsSection" runat="server" class="newsSection persian newsStream">
                            ...
                            <div class="post-fehrest" runat="server" id="post">
                                ...
                                <div class="top-post">
                                    <div class="first-row">
                                        ...
                                        <i class="fa fa-"></i><span class="siteTitle"><%# Eval("SiteTitle") %></span>
                                        <div class="newsrate" runat="server">
                                            <asp:HyperLink runat="server" ID="hypNewsValueNeg" href="#" class="btn_news_notok" title="خبر منفی"
                                                itemid='<%# Eval("NewsId") %>'></asp:HyperLink>
                                            <asp:HyperLink runat="server" ID="hypNewsValueNoRel" href="#" class="btn_news_irrelevant" title="خبر بی ربط"
                                                itemid='<%# Eval("NewsId") %>'></asp:HyperLink>
                                            <asp:HyperLink runat="server" ID="hypNewsValue" href="#" class="btn_news_empty" title="خبر خنثی"
                                                itemid='<%# Eval("NewsId") %>'></asp:HyperLink>
                                            <asp:HyperLink runat="server" ID="hypNewsValueRel" href="#" class="btn_news_lowـcommunication" title="خبر کم ارتباط"
                                                itemid='<%# Eval("NewsId") %>'></asp:HyperLink>
                                            <asp:HyperLink runat="server" ID="hypNewsValuePos" href="#" class="btn_news_ok" title="خبر مثبت"
                                                itemid='<%# Eval("NewsId") %>'></asp:HyperLink>
                                        </div>
                                    </div>
                                    ...
                                    <div class="third-row">
                                        ...
                                        <div class="newstitle-content"><a target="_blank" href='<%# String.Format("/ShowNews/{0}", Eval("NewsId")) %>'><span class="newstitle"><%# Eval("NewsTitle") %></span></a></div>
                                ...
                                <div class="bottom-post">
                                    ...
                                    <a data-id='<%# Eval("NewsId") %>' class="cur-p add-inbox" onclick="addToInbox(this)"><span class="inb-title">افزودن به اینباکس</span></a>
                                ...
                                <div style="display: none;">
                                    ...
                                    <h2>
                                        <a data-keyid='<%# Eval("KeywordName") %>' data-keyword='<%# Eval("KeywordName") %>' target="_blank" href='<%# String.Format("~/ShowNews/{0}", Eval("NewsId")) %>' title='<%#PArt.Pages.P_Art.Repository.Class_Static.ShortTxt(Eval("NewsLead").ToString(),200) %>' data-tooltip='<%# DiffrentDate(Eval("CreateDate"),Eval("SiteType").ToString(),Eval("NewsTime").ToString(),Eval("NewsDate").ToString()) %>'
                                            runat="server">
                        ...
                        <div class="post-content relation" id="news_row" runat="server">
                            ...
                            <div class="top-post">
                                <div class="first-row">
                                    ...
                                    <i class="fa fa-"></i><span class="siteTitle"><%# Eval("SiteTitle") %></span>
                                    <div class="newsrate" runat="server">
                                        <a runat="server" id="hypNewsValueNeg" href="#" class="btn_news_notok" title="خبر منفی"
                                            itemid='<%# Eval("NewsId") %>' style='<%# NewsRateOpacityNew(Eval("NewsValue"),"2") %>'></a>
                                        <a runat="server" id="hypNewsValueNoRel" href="#" class="btn_news_irrelevant" title="خبر بی ربط"
                                            itemid='<%# Eval("NewsId") %>' style='<%# NewsRateOpacityNew(Eval("NewsValue"),"4") %>'></a>
                                        <a runat="server" id="hypNewsValue" href="#" class="btn_news_empty" title="خبر خنثی"
                                            itemid='<%# Eval("NewsId") %>' style='<%# NewsRateOpacityNew(Eval("NewsValue"),"0") %>'></a>
                                        <a runat="server" id="hypNewsValueRel" href="#" class="btn_news_lowـcommunication" title="خبر کم ارتباط"
                                            itemid='<%# Eval("NewsId") %>' style='<%# NewsRateOpacityNew(Eval("NewsValue"),"3") %>'></a>
                                        <a runat="server" id="hypNewsValuePos" href="#" class="btn_news_ok" title="خبر مثبت"
                                            itemid='<%# Eval("NewsId") %>' style='<%# NewsRateOpacityNew(Eval("NewsValue"),"1") %>'></a>
                                    </div>
                                </div>
                                <div style="display:none;" class="second-row">
                                    <span class="sitelink"><%#PArt.Pages.P_Art.Repository.Class_Static.GetDomainName(Eval("NewsLink").ToString()) %></span>
        ...
        <div class="clearfix"></div>
        <div id="groupSection" runat="server" class="newsGroupSection persian newsStream">
    ...
    <script>
        ...
        function DoFinalChangeLog(element) {
            ...
            if (news_grouporder == null) {
                OpenAlert('هشدار', 'لطفا گروه را انتخاب نمایید');
                return;
            }
            $.ajax({
                type: "POST",
    ...
    <script type="text/javascript">
        ...
        $('.selectAllStreemNewsCheckBox input').live('change', function (e) {
            var $this = $(this);
            ...
            if (check) {
                $(".check_SelectNews input").each(function () {
                    this.checked = true;
                });
            }
            else {
