<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="TelegramBultanArchive.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.TelegramBultanArchive" %>
                ...
                <asp:Repeater ID="rpt_result" runat="server">
                    ...
                    <ItemTemplate>
                        <div class="BultanArchiveItem">
                            ...
                            <a class="ControlLeftMargin btn btn-success" id="lnk_download" href='<%# string.Format("/HTMLTelegramReportNew.aspx?ArchiveId={0}",Eval("ArchiveId")) %>' runat="server" target="_blank">مشاهده بولتن
                            </a>
