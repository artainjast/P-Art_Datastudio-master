<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/PanelMasterPage.Master" AutoEventWireup="true" CodeBehind="DataCenter.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.DataCenter" %>
                    ...
                    <div class="showFehrest">
                        <article data-id='groupOrderItem_<%# Eval("NewsId") %>' data-grouporder='<%# Eval("GroupOrder") %>'
                            ...
                            <div class="post-fehrest" runat="server" id="post">
                                ...
                                <h2>
                                    <a data-keyid='<%# Eval("KeywordName") %>' data-keyword='<%# Eval("KeywordName") %>' target="_blank" href='<%# String.Format("~/DataCenterShowNews/{0}", Eval("NewsId")) %>' title='<%#PArt.Pages.P_Art.Repository.Class_Static.ShortTxt(Eval("NewsLead").ToString(),200) %>' data-tooltip='<%# DiffrentDate(Eval("CreateDate"),Eval("SiteType").ToString(),Eval("NewsTime").ToString(),Eval("NewsDate").ToString()) %>'
                                        runat="server">
