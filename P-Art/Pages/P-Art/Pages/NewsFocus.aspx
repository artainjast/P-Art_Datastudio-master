<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/P-Art/MasterPages/SiteV2.Master" AutoEventWireup="true" CodeBehind="NewsFocus.aspx.cs" Inherits="P_Art.Pages.P_Art.Pages.NewsFocus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="newsStream">
        <div class="navTimeLine">
            <ul>
                <li>
                    <a runat="server" id="linkTimeLine">شناسایی تمرکز رسانه ها</a>
                </li>
                <li>
        ...
        <div id="divFilter" style="display: none;" class="filter-news">
            ...
            <asp:Button ID="btn_ShowNews" runat="server" Style='padding: 5px 12px;' CssClass="BlueButton" Text="جستجو اخبار" OnClick="btn_ShowNews_Click" />
        </div>
        ...
        <div class="timeLineSection">
            <div runat="server" id="divTimeLineBody" class="owl-carousel owl-theme owl-rtl owl-loaded owl-drag">
            ...
            <div class="loader-main" runat="server" id="divLoad">
                ...
                <span>جهت بررسی تمرکز رسانه ها بر روی شناسایی تمرکز رسانه ها کلیک کنید</span>
            </div>
        </div>
