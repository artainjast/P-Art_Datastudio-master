...
namespace P_Art
{
    public partial class HTMLTwitterReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (UserPanelList != null)
                {
                    ...
                    BultanTitlePhrase.InnerText = "بولتن شبکه اجتماعی توییتر ";
            ...
            var TwitterPost = _db.Tbl_TwitterPost.Where(M => MessageIds.Contains(M.ID)).ToList();
            int rowIndex = 0;
            int pageNumber = 0;
            ...
            foreach (var Post in TwitterPost)
            {
                int MessageCharSize = Post.Text.Length + 18 + Post.UserName.Length + 250;
