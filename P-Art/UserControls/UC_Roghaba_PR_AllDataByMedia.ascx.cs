...
{
    public partial class UC_Roghaba_PR_AllDataByMedia : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //  HiddenField hddParmin = FindControl("hddParmin") as HiddenField;
                //HiddenField hddParmin = e.GetType().FindControl("hddParmin") as HiddenField;
                try
                {
                    if (hddParmin2 != null)
                        hddParmin2.Value = ParminTable.ParminID.ToString();
                }
                catch
                {
