<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ChartWelcome_Bultan.ascx.cs" Inherits="P_Art.UserControls.UC_ChartWelcome_Bultan" %>
...
<link href="/UserControls/uc_chart_bultan.css" rel="stylesheet" />
<div style="display: none;">
    <asp:HiddenField ID="hddParmin2" runat="server" />
    <asp:HiddenField ID="hddParmin" runat="server" />
    <asp:HiddenField ID="hddFromDate" runat="server" />
    <asp:HiddenField ID="hddToDate" runat="server" />
...
<div id="mainSection" class="container-fluid">
    ...
    <!-- first page of chart -->
    <div runat="server" id="divFirstPage" class="page newsContainer chartlayout">
        <div class="chartRow row rtl">
            <div runat="server" id="div_all_top_news" class="col-md-3">
            ...
            <div runat="server" id="div_all_top_social" class="col-md-3">
                <figure class="highcharts-figure container-fluid all_rates">
                    <span class="title">تعداد کل در شبکه های اجتماعی</span>
            ...
            <div runat="server" id="div_all_top_video" class="col-md-3">
                <figure class="highcharts-figure container-fluid all_rates">
            ...
            <div runat="server" id="div_all_top_radio" class="col-md-3">
                <figure class="highcharts-figure container-fluid all_rates">
        ...
        <div class="social_all_count rtl">
            ...
            <div runat="server" id="div_all_instagram" class="social_all social_all_instagram">
            ...
            <div runat="server" id="div_all_twitter" class="social_all social_all_twitter">
            ...
            <div runat="server" id="div_all_telegram" class="social_all social_all_telegram">
            ...
            <div runat="server" id="div_all_website" class="social_all social_all_website">
            ...
            <div runat="server" id="div_all_newspaper" class="social_all social_all_newspaper">
        ...
        <div runat="server" id="div_social_count_day">
    ...
    <!-- first page of chart ending -->

    <!-- second page of chart -->
    <div runat="server" id="divSecondPage" class="page newsContainer chartlayout">
        <div class="chartRow row ">
            <div class="col-md-12">
                <div runat="server" id="div_top_hashtag" class="col-md-12 highcharts-figure ">

                    <div id="container-top-hashtag" class="content_container_preload_min"></div>
                </div>
                <div runat="server" id="div_jensiat" class="col-md-12 highcharts-figure chartRow">
    ...
    <!-- second page of chart ending-->


    <!-- third page of chart -->
    <div runat="server" id="divThirdPage" class="page newsContainer chartlayout">
        <div class="chartRow row ">
            <div runat="server" id="div_news_mosbat_manfi" class="col-md-12 highcharts-figure chartRow">

                <div id="container-news-mosbat-manfi" class="content_container_preload_min"></div>

            </div>
            <div class="col-md-12">
                <div runat="server" id="div_top_twitter" class="col-md-12 highcharts-figure " style="position: relative;">
                ...
                <div runat="server" id="div_sugiri_webnewspaper_mosbat" class="col-md-12 highcharts-figure chartRow ">

                    <div id="container-sugiri-webnewspaper-mosbat" class="content_container_preload"></div>

                </div>
                <div runat="server" id="div_sugiri_webnewspaper_manfi" class="col-md-12 highcharts-figure chartRow ">
    ...
    <!-- third page of chart ending -->

    <!-- fourth page of chart -->
    <div runat="server" id="divFourthPage" class="page newsContainer chartlayout">
        <div class="chartRow row">
            <div runat="server" id="div_cloud_chart_twitter" class="col-md-6 ">
                <figure class="highcharts-figure container-fluid">
                    <div class='content_container_preload' id='CloudChartTwitter'></div>
                </figure>
            </div>
            <div runat="server" id="div_cloud_chart_news" class="col-md-6">
                <figure class="highcharts-figure container-fluid">
                    <div class='content_container_preload' id='CloudChartNews'></div>
                </figure>
            </div>
            <div runat="server" id="div_map_twitter" class="col-md-12 margin-top-10">
                <figure class="highcharts-figure container-fluid map_twitter">
    ...
    <!-- fourth page of chart ending -->


    <!-- fifth page of chart -->
    <div runat="server" id="divFifthPage" class="page newsContainer chartlayout">
        <div class="chartRow row">

            <div runat="server" id="div_map_telegram" class="col-md-12 margin-top-10">
                <figure class="highcharts-figure container-fluid map_telegram">
                    <header class="clearfix">
    ...
    ">
            ...
            <div runat="server" id="div_map_instagram" class="col-md-12 margin-top-10">
                <figure class="highcharts-figure container-fluid map_instagram">
                    <header class="clearfix">
...
<!-- fifth page of chart ending -->

<!-- sixth page of chart  -->
<div runat="server" id="divSixthPage" class="page newsContainer chartlayout">
    <div class="chartRow row">
        <div runat="server" id="div_news_bohransaz_mosbat" class="col-md-6 ">
            <figure class="highcharts-figure container-fluid">
                <div class='content_container_preload' style="height: 400px" id='news_bohransaz_mosbat'></div>
            </figure>
        </div>
        <div runat="server" id="div_news_bohransaz_manfi" class="col-md-6">
            <figure class="highcharts-figure container-fluid">
                <div class='content_container_preload' style="height: 400px" id='news_bohransaz_manfi'></div>
            </figure>
        </div>
        <div visible="false" runat="server" id="div_newspaper" class="col-md-12 ">
            <figure class="highcharts-figure container-fluid">
...
<!-- sixth page of chart ending -->

<div style="display: none" class="chartRow row rtl">
...
<div style="display: none" class="chartRow container-fluid topChannels rtl">
...
<script type="text/javascript">
	...
	function Load_CloudChartNews() {
        ...
        var newsData = [];
        var newsDataTwitter = [];
        var fromDate = $("#<%= hddFromDate.ClientID %>").val();
        var toDate = $("#<%= hddToDate.ClientID %>").val();
        var fd = $("#<%= hddFromDate.ClientID %>").val();
        var td = $("#<%= hddToDate.ClientID %>").val();
        var ft = '';
        var tt = '';
        var k = '';
    ...
    function LoadTop_AllNews() {
        ...
        var archive = $("#<%= hddId.ClientID %>").val();
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminTop_AllNews_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    function LoadTop_AllRadio() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminTop_AllRadio_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
	...
	function LoadTop_AllVideo() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminTop_AllVideo_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
	...
	function LoadTop_AllSocial() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminTop_AllSocial_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
	...
	function LoadAll_NewsPaper() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminAll_Count_Newspaper_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
	...
	function LoadAll_Website() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminAll_Count_Website_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
    ...
    function LoadAll_Instagram() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminAll_Count_Instagram_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
	...
	function LoadAll_Twitter() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminAll_Count_Twitter_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
    ...
    function LoadAll_Telegram() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminAll_Count_Telegram_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
    ...
    function LoadAll_Count() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/GetParminAll_ByMedia_Selection',
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
    ...
    function Load_TV_Count_All() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "/Services/Service_BultanReport.aspx/TV_Count_All_Selection",
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    function Load_Social_Count_Day() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "/Services/Service_BultanReport.aspx/Social_Count_Day_Selection",
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    function Load_Social_Count_All() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "/Services/Service_BultanReport.aspx/Social_Count_All_Selection",
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    function Load_WebNewspaper_Count_All() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "/Services/Service_BultanReport.aspx/WebNewspaper_Count_All_Selection",
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    function Load_Hashtag_Top_All() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "/Services/Service_BultanReport.aspx/Hashtag_Top_All_Selection",
                data: "{'id':'" + archive + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    function Load_Hashtag_Top_Count() {
        ...
        try {
            $.ajax({
                type: "POST",
                url: '/Services/Service_BultanReport.aspx/Hashtag_Top_CountSelection',
                data: "{'id':'" + archive + "','count':3}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
