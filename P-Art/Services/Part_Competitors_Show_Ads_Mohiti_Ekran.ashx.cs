...
{
    /// <summary>
    /// Summary description for Part_Competitors_Show_Ads_Mohiti_Ekran
    /// </summary>
    public class Part_Competitors_Show_Ads_Mohiti_Ekran : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            var values = new List<Tbl_Advertise_General>();
            ...
            values = (new Class_Competitors_Data()).GetCompetitorsShowAdsAdvertiseEkran(ParminId, fromDateTimeIndex, toDateTimeIndex);
