...
{
    /// <summary>
    /// Summary description for Part_Competitors_Ads_Radio_AllData
    /// </summary>
    public class Part_Competitors_Ads_Radio_AllData : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.Write(jsonSerializer.Serialize(radios));
        }
