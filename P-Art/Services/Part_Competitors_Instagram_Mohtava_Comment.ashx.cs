...
{
    /// <summary>
    /// Summary description for Part_Competitors_Instagram_Mohtava_Comment
    /// </summary>
    public class Part_Competitors_Instagram_Mohtava_Comment : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.Write(jsonSerializer.Serialize(count));
        }
