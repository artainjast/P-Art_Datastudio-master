...
{
    /// <summary>
    /// Summary description for Part_Competitors_Ads_Mohiti_Ekran
    /// </summary>
    public class Part_Competitors_Ads_Mohiti_Ekran : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            values = (new Class_Competitors_Data()).GetCompetitorsAdsAdvertiseEkran(ParminId, fromDateTimeIndex, toDateTimeIndex);
