...
{
    /// <summary>
    /// Summary description for Part_Competitors_Abri_BySource
    /// </summary>
    public class Part_Competitors_Abri_BySource : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            List<ChartData> news = (new Class_Competitors_Data()).GetCompetitorsNewsByKeyword(ParminId, fromDateIndex, toDateIndex);


            JavaScriptSerializer jsonSerializer = new JavaScriptSerializer();
            context.Response.Write(jsonSerializer.Serialize(news));
        }
