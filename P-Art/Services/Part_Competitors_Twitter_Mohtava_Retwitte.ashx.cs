...
{
    /// <summary>
    /// Summary description for Part_Competitors_Twitter_Mohtava_Retwitte
    /// </summary>
    public class Part_Competitors_Twitter_Mohtava_Retwitte : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ChartData view = (new Class_Competitors_Data()).GetCompetitorsTwitterRetwitte(ParminId, fromDateTimeIndex, toDateTimeIndex);
            long viewCount = 0;
