...
{
    /// <summary>
    /// Summary description for Part_Competitors_Twitter_Mohtava_All
    /// </summary>
    public class Part_Competitors_Twitter_Mohtava_All : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            ChartData view = (new Class_Competitors_Data()).GetCompetitorsTwitterAll(ParminId, fromDateTimeIndex, toDateTimeIndex);
            long viewCount = 0;
